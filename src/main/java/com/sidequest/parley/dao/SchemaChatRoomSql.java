...
public class SchemaChatRoomSql {
    ...
    public static final String SELECT_CHAT_ROOM_BY_NAME = "SELECT * FROM chat_room WHERE name = ?";
    public static final String SELECT_CHAT_ROOM_BY_MODERATOR_ID = "SELECT * FROM chat_room WHERE moderatorId = ?";
